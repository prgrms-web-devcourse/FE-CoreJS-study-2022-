...
1. 하위 클래스의 `dunder proto`가 상위 클래스의 프로토타입 객체르 참조한다.
...
```js
let extendsClass = function (SupperClass, SubClass, subMethods) {
  SubClass.prototype = Object.create(SupperClass.prototype);
  SubClass.prototype.constructor = SubClass;
  ...
  SubClass.prototype.super = function (propName) {
    ...
    if (!propName)
      return function () {
        SupperClass.apply(self, arguments);
      };
    let prop = SupperClass.prototype[propName];
